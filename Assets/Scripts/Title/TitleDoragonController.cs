...
public class TitleDoragonController : TitleEnemyController
{
    ...
    void Update()
    {
        ...
        if (transform.position.x < -width) transform.position = new Vector3(width, transform.position.y, transform.position.z);
    }
}
